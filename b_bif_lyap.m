%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Bifurcation and lyapunov exponent diagrams for parameter b.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
nparam = 500;
parameter_vec = linspace(0,50,nparam);
...
figure()
    ...
    xlabel(t,"$b$ (Larval recruitement without cannibalism)",'interpreter','latex',"FontSize",24)
